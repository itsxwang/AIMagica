...
function Home() {
  return (
    <>
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white flex flex-col items-center px-4 py-12 font-(family-name:--poppins) md:justify-center gap-7">
    <img src="./public/applogo2.jpg" alt="" height={"100px"} width={"100px"} style={{ borderRadius: "50%" }} />
      ...
      <div className='flex flex-col items-center'>
        ...
        <p className="custom-st-para text-lg md:text-xl text-gray-300 text-center max-w-2xl">
